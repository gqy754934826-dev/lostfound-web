        ...
        <el-table-column label="操作">
          <template #default="scope">
            ...
            <el-button 
              ...
              size="small" 
              type="success" 
              @click="approveItem(scope.row.id)"
            >通过</el-button>
            <el-button 
              v-if="scope.row.status === 0" 
              size="small" 
              type="danger" 
              @click="rejectItem(scope.row.id)"
            >拒绝</el-button>
            <el-button 
              size="small" 
              type="danger" 
...
import { getItemList, updateItemStatus, deleteItemById } from '../../api/item';
